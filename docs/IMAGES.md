...
Every current image is **self-authored placeholder SVG artwork** generated by
`node scripts/generate-placeholders.mjs` — license-clean, but meant to be replaced with real
